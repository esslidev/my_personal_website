...
class AppColors {
  ...
  static const Color greenCalliste = Color(0xFF7B7C4F);
...
class LightTheme {
  final Color primaryColor1 = AppColors.yellowColombianGold;
  final Color primaryColor2 = AppColors.greenCalliste;
